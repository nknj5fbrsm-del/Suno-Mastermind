...
export const t = {
  de: {
    ...
    dashboard: {
      ...
      deleteAllConfirm: 'Wirklich alle Archiv-Einträge löschen? Dies kann nicht rückgängig gemacht werden.',
  ...
  en: {
    ...
    dashboard: {
      ...
      deleteAllConfirm: 'Do you really want to delete all archive entries? This cannot be undone.',
